...
# Tcl script used by earth.lua. This requires that you have the Tcl/Tk
# bindings of VTK (http://www.vtk.org/) installed. This script illustrates:
# - How to create a basic VTK rendering pipeline and use it in Lua.
